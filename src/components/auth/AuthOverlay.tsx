...
export const AuthStatus = ({ onLogin }: Props) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="max-w-[450px] w-full mx-auto p-4 sm:p-8 border border-slate-200 rounded-3xl bg-white shadow-xl shadow-slate-200/50 relative">
        <div className="text-center mb-6">
          ...
          <h2 className="text-[#002855] text-2xl font-bold m-0">Comparativa Naturgy</h2>
          <p className="text-slate-400 text-xs mt-1">Acceso de administrador</p>
        </div>
